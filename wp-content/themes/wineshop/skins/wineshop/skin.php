	...
	function themerex_action_skin_theme_setup() {
		...
		*/
		...
		themerex_add_color_scheme('original', array(
			...
			'title'					=> esc_html__('Original', 'themerex'),

			// Accent colors
			'accent1'				=> '#B4BB6B',
			'accent1_hover'			=> '#2B2B2B',
			'accent2'				=> '#B4BB6B',
			'accent2_hover'			=> '#2B2B2B',
			'accent3'				=> '#B4BB6B',
			'accent3_hover'			=> '#2B2B2B',
			...
			'alter_link'			=> '#B4BB6B',
			'alter_hover'			=> '#ffffff',
			'alter_bd_color'		=> '#000000',
			'alter_bd_hover'		=> '#000000',
		...
		themerex_add_color_scheme('dark', array(
			...
			// Accent colors
			'accent1'				=> '#ffffff',
			'accent1_hover'			=> '#9F2348',
			'accent2'				=> '#ffffff',
			'accent2_hover'			=> '#9F2348',
			'accent3'				=> '#ffffff',
			'accent3_hover'			=> '#9F2348',
			...
			'text_dark'				=> '#ffffff',
			'inverse_text'			=> '#7a7976',
			'inverse_light'			=> '#9f2348',
			'inverse_dark'			=> '#232a34',
			'inverse_link'			=> '#ffffff',
			'inverse_hover'			=> '#9F2348',
		...
		*/
		...
		themerex_add_custom_font('h1', array(
			'title'			=> esc_html__('Heading 1', 'themerex'),
			'description'	=> '',
			'font-family'	=> '',
			'font-size' 	=> '72px',
			'font-weight'	=> '500',
		...
		themerex_add_custom_font('h2', array(
			'title'			=> esc_html__('Heading 2', 'themerex'),
			'description'	=> '',
			'font-family'	=> '',
			'font-size' 	=> '60px',
			'font-weight'	=> '500',
		...
		themerex_add_custom_font('h3', array(
			'title'			=> esc_html__('Heading 3', 'themerex'),
			'description'	=> '',
			'font-family'	=> '',
			'font-size' 	=> '48px',
			'font-weight'	=> '500',
		...
		themerex_add_custom_font('h4', array(
			'title'			=> esc_html__('Heading 4', 'themerex'),
			'description'	=> '',
			'font-family'	=> '',
			'font-size' 	=> '30px',
			'font-weight'	=> '600',
		...
		themerex_add_custom_font('h5', array(
			'title'			=> esc_html__('Heading 5', 'themerex'),
			'description'	=> '',
			'font-family'	=> '',
			'font-size' 	=> '18px',
			'font-weight'	=> '600',
		...
		themerex_add_custom_font('h6', array(
			'title'			=> esc_html__('Heading 6', 'themerex'),
			'description'	=> '',
			'font-family'	=> '',
			'font-size' 	=> '16px',
			'font-weight'	=> '600',
		...
		themerex_add_custom_font('info', array(
			'title'			=> esc_html__('Post info', 'themerex'),
			'description'	=> '',
			'font-family'	=> '',
			'font-size' 	=> '14px',
			'font-weight'	=> '',
		...
		themerex_add_custom_font('menu', array(
			'title'			=> esc_html__('Main menu items', 'themerex'),
			'description'	=> '',
			'font-family'	=> '',
			'font-size' 	=> '14px',
			'font-weight'	=> '',
		...
		themerex_add_custom_font('submenu', array(
			'title'			=> esc_html__('Dropdown menu items', 'themerex'),
			'description'	=> '',
			'font-family'	=> '',
			'font-size' 	=> '16',
			'font-weight'	=> '',
		...
		themerex_add_custom_font('logo', array(
			'title'			=> esc_html__('Logo', 'themerex'),
			'description'	=> '',
			'font-family'	=> '',
			'font-size' 	=> '2.8571em',
			'font-weight'	=> '700',
		...
		themerex_add_custom_font('button', array(
			'title'			=> esc_html__('Buttons', 'themerex'),
			'description'	=> '',
			'font-family'	=> '',
			'font-size' 	=> '10px',
			'font-weight'	=> '400',
		...
		themerex_add_custom_font('input', array(
			'title'			=> esc_html__('Input fields', 'themerex'),
			'description'	=> '',
			'font-family'	=> '',
			'font-size' 	=> '14px',
			'font-weight'	=> '',
...
.woocommerce ul.products li.product .post_featured .hover_icon .view_button:hover, .woocommerce-page ul.products li.product .post_featured .hover_icon .view_button:hover{ 
...
body, .widget_area_inner ul li a,
...
.sc_blogger .hover_icon_link:after, .isotope_item_masonry .hover_icon_link:after{
	background-color: '.$clr['text_light'].';
}
...
.menu_main_nav > li > a,
.top_panel_style_5 .menu_main_info .phone, .top_panel_style_5 .menu_main_cart .text,
...
.top_panel_title.title_present .breadcrumbs a{
	color: '.$clr['inverse_dark'].' !important;
}
.ih-item.square .info .post_title a{
	color: '.$clr['inverse_link'].' !important;
}
.ih-item.square .info .post_title a:hover{
	color: '.$clr['inverse_hover'].' !important;
}

td, th,
.sc_line,
.sidebar_inner aside:nth-child(3n+4), .sidebar_inner aside:nth-child(3n+5), 
.sidebar_inner aside:nth-child(3n+6), .sidebar_outer_inner aside:nth-child(3n+4), 
.sidebar_outer_inner aside:nth-child(3n+5), .sidebar_outer_inner aside:nth-child(3n+6), 
.widget_area_inner aside:nth-child(2n+3), .widget_area_inner aside:nth-child(2n+4), 
.widget_area_inner aside + aside,
.sc_tabs.sc_tabs_style_1 .sc_tabs_content, .sc_tabs.sc_tabs_style_2 .sc_tabs_content,
.sc_tabs.sc_tabs_style_1 .sc_tabs_titles li a,
.sc_tabs.sc_tabs_style_2 .sc_tabs_titles li a,
.top_panel_style_5 .menu_main_info .icon, 
.top_panel_style_5 .menu_main_cart .contact_icon,
.top_panel_style_5 .menu_main_wrap{
	border-color: '.$clr['bd_color'].';
}
...
.sc_skills_counter .sc_skills_item.sc_skills_style_1 .sc_skills_info:before{
	background-color: '.$clr['bd_color'].';
}

.body_wrap{
	background-image: url('.$clr['bg_image'].');
	background-position: '.$clr['bg_image_position'].';
	background-repeat: '.$clr['bg_image_repeat'].';
	background-attachment: '.$clr['bg_image_attachment'].';
	
	background-image: url('.$clr['bg_image2'].');
	background-position: '.$clr['bg_image2_position'].';
	background-repeat: '.$clr['bg_image2_repeat'].';
	background-attachment: '.$clr['bg_image2_attachment'].';
}
.top_panel_middle,
.copy_wrap, 
.sidebar_cart, 
...
.sc_skills_bar.sc_skills_horizontal .sc_skills_total:after {
	border-top-color: '.$clr['accent1_hover'].';
}
...
.contacts_wrap_inner {
	...
	background-image: url('.$clr['alter_bg_image'].');
	background-position: '.$clr['alter_bg_image_position'].';
	background-repeat: '.$clr['alter_bg_image_repeat'].';
	background-attachment: '.$clr['alter_bg_image_attachment'].';
}
