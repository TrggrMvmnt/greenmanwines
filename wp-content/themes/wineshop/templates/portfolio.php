...
if ( !function_exists( 'themerex_template_portfolio_theme_setup' ) ) {
	...
	function themerex_template_portfolio_theme_setup() {
		themerex_add_template(array(
			...
			'mode'   => 'blog',
			'need_isotope' => true,
			'title'  => esc_html__('Portfolio tile (with hovers, different height) /2 columns/', 'themerex'),
			'thumb_title'  => esc_html__('Large image', 'themerex'),
			'w'		 => 870,
			'h_crop' => 490,
			'h'		 => null
		));
		themerex_add_template(array(
			...
			'mode'   => 'blog',
			'need_isotope' => true,
			'title'  => esc_html__('Portfolio tile /3 columns/', 'themerex'),
			'thumb_title'  => esc_html__('Medium image', 'themerex'),
			'w'		 => 390,
			'h_crop' => 220,
			'h'		 => null
		));
		themerex_add_template(array(
			...
			'mode'   => 'blog',
			'need_isotope' => true,
			'title'  => esc_html__('Portfolio tile /4 columns/', 'themerex'),
			'thumb_title'  => esc_html__('Small image', 'themerex'),
			'w'		 => 300,
			'h_crop' => 170,
			'h'		 => null
		));
		themerex_add_template(array(
			...
			'title'  => esc_html__('Grid tile (with hovers, equal height) /2 columns/', 'themerex'),
			'thumb_title'  => esc_html__('Large image (crop)', 'themerex'),
			'w'		 => 870,
			'h' 	 => 490
		));
		themerex_add_template(array(
			...
			'need_isotope' => true,
			'container_classes' => 'no_margins',
			'title'  => esc_html__('Grid tile /3 columns/', 'themerex'),
			'thumb_title'  => esc_html__('Medium image (crop)', 'themerex'),
			'w'		 => 390,
			'h'		 => 220
		));
		themerex_add_template(array(
			...
			'need_isotope' => true,
			'container_classes' => 'no_margins',
			'title'  => esc_html__('Grid tile /4 columns/', 'themerex'),
			'thumb_title'  => esc_html__('Small image (crop)', 'themerex'),
			'w'		 => 300,
			'h'		 => 170
		));
		themerex_add_template(array(
			...
			'need_isotope' => true,
			'container_classes' => 'no_margins',
			'title'  => esc_html__('Square tile (with hovers, width=height) /2 columns/', 'themerex'),
			'thumb_title'  => esc_html__('Large square image (crop)', 'themerex'),
			'w'		 => 870,
			'h' 	 => 870
		));
		themerex_add_template(array(
			...
			'need_isotope' => true,
			'container_classes' => 'no_margins',
			'title'  => esc_html__('Square tile /3 columns/', 'themerex'),
		...
		themerex_add_template(array(
			...
			'need_isotope' => true,
			'container_classes' => 'no_margins',
			'title'  => esc_html__('Square tile /4 columns/', 'themerex'),
		...
		themerex_add_template(array(
			...
			'need_isotope' => true,
			'need_terms' => true,
			'title'  => esc_html__('Colored excerpt', 'themerex'),
			'thumb_title'  => esc_html__('Small square image (crop)', 'themerex'),
			'w'		 => 760,
			'h'		 => 500
		));
		themerex_add_template(array(
			...
			'need_isotope' => true,
			'need_terms' => true,
			'title'  => esc_html__('Colored tile (with hovers, width=height) /2 columns/', 'themerex'),
			'thumb_title'  => esc_html__('Large square image (crop)', 'themerex'),
			'w'		 => 870,
			'h' 	 => 870
		));
		themerex_add_template(array(
			...
			'need_isotope' => true,
			'need_terms' => true,
			'title'  => esc_html__('Colored tile /3 columns/', 'themerex'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'themerex'),
			'w'		 => 390,
			'h'		 => 390
		));
		themerex_add_template(array(
			...
			'need_isotope' => true,
			'need_terms' => true,
			'title'  => esc_html__('Colored tile /4 columns/', 'themerex'),
			'thumb_title'  => esc_html__('Small square image (crop)', 'themerex'),
			'w'		 => 300,
			'h'		 => 300
		));
		themerex_add_template(array(
			...
			'need_terms' => true,
			'container_classes' => 'no_margins',
			'title'  => esc_html__('Short info /2 columns/', 'themerex'),
			'thumb_title'  => esc_html__('Large square image (crop)', 'themerex'),
			'w'		 => 870,
			'h' 	 => 870
		));
		themerex_add_template(array(
			...
			'need_terms' => true,
			'container_classes' => 'no_margins',
			'title'  => esc_html__('Short info /3 columns/', 'themerex'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'themerex'),
			'w'		 => 390,
			'h'		 => 390
		));
		themerex_add_template(array(
			...
			'need_terms' => true,
			'container_classes' => 'no_margins',
			'title'  => esc_html__('Short info /4 columns/', 'themerex'),
			'thumb_title'  => esc_html__('Small square image (crop)', 'themerex'),
			'w'		 => 300,
			'h'		 => 300
		));
		themerex_add_template(array(
			...
			'title'  => esc_html__('Alternative grid (with hovers) /2 columns/', 'themerex'),
			'thumb_title'  => esc_html__('Large square image (crop)', 'themerex'),
			'w'		 => 870,
			'h' 	 => 870
		));
		themerex_add_template(array(
			...
			'need_isotope' => true,
			'container_classes' => 'small_margins',
			'title'  => esc_html__('Alternative grid /3 columns/', 'themerex'),
			'thumb_title'  => esc_html__('Medium square image (crop)', 'themerex'),
			'w'		 => 390,
			'h'		 => 390
		));
		themerex_add_template(array(
			...
			'need_isotope' => true,
			'container_classes' => 'small_margins',
			'title'  => esc_html__('Alternative grid /4 columns/', 'themerex'),
			'thumb_title'  => esc_html__('Small square image (crop)', 'themerex'),
			'w'		 => 300,
			'h'		 => 300
		));
		themerex_add_template(array(
			...
			'mode'   => 'blog',
			'need_isotope' => true,
			'title'  => esc_html__('Course tile (different height) /2 columns/', 'themerex'),
			'thumb_title'  => esc_html__('Large image', 'themerex'),
			'w'		 => 870,
			'h_crop' => 490,
			'h'      => null
		...
		themerex_add_template(array(
			...
			'mode'   => 'blog',
			'need_isotope' => true,
			'title'  => esc_html__('Course tile /3 columns/', 'themerex'),
			'thumb_title'  => esc_html__('Medium image', 'themerex'),
			'w'		 => 390,
			'h_crop' => 220,
			'h'      => null
		...
		themerex_add_template(array(
			...
			'mode'   => 'blog',
			'need_isotope' => true,
			'title'  => esc_html__('Course tile /4 columns/', 'themerex'),
			'thumb_title'  => esc_html__('Small image', 'themerex'),
			'w'		 => 300,
			'h_crop' => 170,
			'h'      => null
	...
	function themerex_template_portfolio_output($post_options, $post_data) {
		...
		if ($style == 'colored' && $columns==1) {				// colored excerpt style (1 column)
			...
			<div class="isotope_item isotope_item_colored isotope_item_colored_1 isotope_column_1
						...
						?>">
				<<?php echo balanceTags($tag); ?> class="post_item post_item_colored post_item_colored_1
					...
					<div class="post_content isotope_item_content">
						<div class="post_featured img">
							...
							*/
							...
							echo balanceTags($link_start) . ($post_data['post_thumb']) . ($link_end);
							...
							if ($new && $new > date('Y-m-d')) {
								?><div class="post_mark_new"><?php esc_html_e('NEW', 'themerex'); ?></div><?php
							}
							?>
						</div>
		
						<div class="post_content clearfix">
							<h4 class="post_title"><?php echo balanceTags($link_start) . ($post_data['post_title']) . ($link_end); ?></h4>
							<div class="post_info">
								<?php
							...
							<?php echo balanceTags($reviews_summary); ?>
							<div class="post_descr">
								<?php echo trim($post_data['post_excerpt']); ?>
							</div>
							<?php if ($post_data['post_link'] != '') { ?>
								<div class="post_buttons">
									<?php echo trim(themerex_sc_button(array('size'=>'small', 'link'=>$post_data['post_link']), esc_html__('LEARN MORE', 'themerex'))); ?>
								</div>
							<?php } ?>
						</div>
					</div>				<!-- /.post_content -->
				</<?php echo balanceTags($tag); ?>>	<!-- /.post_item -->
			</div>						<!-- /.isotope_item -->
			<?php
			...
			<div class="isotope_item isotope_item_<?php echo esc_attr($style); ?> isotope_item_<?php echo esc_attr($post_options['layout']); ?> isotope_column_<?php echo esc_attr($columns); ?>
						...
						?>">
				<<?php echo balanceTags($tag); ?> class="post_item post_item_<?php echo esc_attr($style); ?> post_item_<?php echo esc_attr($post_options['layout']); ?>
					<?php echo 'post_format_'.esc_attr($post_data['post_format']) 
						. ($post_options['number']%2==0 ? ' even' : ' odd') 
						. ($post_options['number']==0 ? ' first' : '') 
						. ($post_options['number']==$post_options['posts_on_page'] ? ' last' : '');
					...
					<div class="post_content isotope_item_content ih-item colored<?php
									echo balanceTags($post_options['hover'] ? ' '.esc_attr($post_options['hover']) : '')
						...
						<div class="post_featured img">
							...
							*/
							...
							if ($style=='colored_1') {
								...
								<div class="post_descr">
									...
									$category = !empty($post_data['post_terms'][$post_data['post_taxonomy']]->terms) 
												...
												: '';
									?>
									<div class="post_category"><?php echo balanceTags($category); ?></div>
									<?php echo balanceTags($reviews_summary); ?>
								</div>
								<?php
							}
							...
							if ($show_title && $style == 'courses') {   
								...
								?>
									<h4 class="post_title"><a href="<?php echo esc_url($post_data['post_link']); ?>"><?php echo balanceTags($post_data['post_title']); ?></a></h4>
								<?php
								} else {
								?>
										<h4 class="post_title"><?php echo balanceTags($post_data['post_title']); ?></h4>
								<?php
									}
							}
							...
							?>
								...
								require(themerex_get_file_dir('templates/_parts/reviews-summary.php'));
								echo balanceTags($reviews_summary); 

								$post_options['readmore'] = 'read more';
							} ?>
						...
						<div class="post_info_wrap info"><div class="info-back">
							...
							<?php
							if ($show_title) {
								?><h4 class="post_title"><?php echo balanceTags($link_start) . ($post_data['post_title']) . ($link_end); ?></h4><?php
							}
							?>
							...
							<?php
								if ($post_data['post_protected']) {
									echo balanceTags($link_start) . ($post_data['post_excerpt']) . ($link_end);
								} else {
									...
									if ($post_data['post_link'] != '') {
										...
										if ($style=='colored_1') {
											...
											echo trim(themerex_sc_button(array('size'=>'small', 'link'=>$post_data['post_link']), esc_html__('Learn more', 'themerex')));
											?></span><?php
