...
if (!themerex_param_is_off($show_share)) {
	...
	if ($rez) {
		?>
		<div class="post_info post_info_bottom post_info_share post_info_share_<?php echo esc_attr($show_share); ?>"><?php echo balanceTags($rez); ?></div>
		<?php
	}
}
?>