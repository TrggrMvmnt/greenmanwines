...
if (!function_exists('themerex_sc_toggles')) {	
	...
	if (function_exists('themerex_utils_require_shortcode')) themerex_utils_require_shortcode('trx_toggles', 'themerex_sc_toggles');
}
...
if (!function_exists('themerex_sc_toggles_item')) {	
	...
	if (function_exists('themerex_utils_require_shortcode')) themerex_utils_require_shortcode('trx_toggles_item', 'themerex_sc_toggles_item');
}
...
if ( !function_exists( 'themerex_sc_toggles_reg_shortcodes' ) ) {
	...
	function themerex_sc_toggles_reg_shortcodes() {
		...
		$THEMEREX_GLOBALS['shortcodes']["trx_toggles"] = array(
			...
			"desc" => wp_kses( __("Toggles items", "themerex"), $THEMEREX_GLOBALS['allowed_tags'] ),
			"decorate" => true,
			"container" => false,
			"params" => array(
				"counter" => array(
					"title" => esc_html__("Counter", "themerex"),
					"desc" => wp_kses( __("Display counter before each toggles title", "themerex"), $THEMEREX_GLOBALS['allowed_tags'] ),
					"value" => "off",
					"type" => "switch",
				...
				"icon_closed" => array(
					...
					"desc" => wp_kses( __('Select icon for the closed toggles item from Fontello icons set',  'themerex'), $THEMEREX_GLOBALS['allowed_tags'] ),
					"value" => "",
					"type" => "icons",
				...
				"icon_opened" => array(
					...
					"desc" => wp_kses( __('Select icon for the opened toggles item from Fontello icons set',  'themerex'), $THEMEREX_GLOBALS['allowed_tags'] ),
					"value" => "",
					"type" => "icons",
					"options" => $THEMEREX_GLOBALS['sc_params']['icons']
				),
			...
			"children" => array(
				...
				"desc" => wp_kses( __("Toggles item", "themerex"), $THEMEREX_GLOBALS['allowed_tags'] ),
				"container" => true,
				"params" => array(
					"title" => array(
						"title" => esc_html__("Toggles item title", "themerex"),
						"desc" => wp_kses( __("Title for current toggles item", "themerex"), $THEMEREX_GLOBALS['allowed_tags'] ),
						"value" => "",
						"type" => "text"
					),
					"open" => array(
						"title" => esc_html__("Open on show", "themerex"),
						"desc" => wp_kses( __("Open current toggles item on show", "themerex"), $THEMEREX_GLOBALS['allowed_tags'] ),
						"value" => "no",
						"type" => "switch",
					...
					"_content_" => array(
						...
						"desc" => wp_kses( __("Current toggles item content", "themerex"), $THEMEREX_GLOBALS['allowed_tags'] ),
						"rows" => 4,
						"value" => "",
						"type" => "textarea"
					),
...
if ( !function_exists( 'themerex_sc_toggles_reg_shortcodes_vc' ) ) {
	...
	function themerex_sc_toggles_reg_shortcodes_vc() {
		...
		vc_map( array(
			...
			"description" => wp_kses( __("Toggles items", "themerex"), $THEMEREX_GLOBALS['allowed_tags'] ),
			...
			"params" => array(
				array(
					...
					"description" => wp_kses( __("Display counter before each toggles title", "themerex"), $THEMEREX_GLOBALS['allowed_tags'] ),
					"class" => "",
				...
				array(
					...
					"description" => wp_kses( __("Select icon for the closed toggles item from Fontello icons set", "themerex"), $THEMEREX_GLOBALS['allowed_tags'] ),
					"class" => "",
				...
				array(
					...
					"description" => wp_kses( __("Select icon for the opened toggles item from Fontello icons set", "themerex"), $THEMEREX_GLOBALS['allowed_tags'] ),
					"class" => "",
					"value" => $THEMEREX_GLOBALS['sc_params']['icons'],
					"type" => "dropdown"
				),
			...
			"custom_markup" => '
				...
				<div class="tab_controls">
					<button class="add_tab" title="'.esc_attr__("Add item", "themerex").'">'.esc_html__("Add item", "themerex").'</button>
				</div>
			',
		...
		vc_map( array(
			...
			"description" => wp_kses( __("Single toggles item", "themerex"), $THEMEREX_GLOBALS['allowed_tags'] ),
			...
			"params" => array(
				array(
					...
					"description" => wp_kses( __("Title for current toggles item", "themerex"), $THEMEREX_GLOBALS['allowed_tags'] ),
					"admin_label" => true,
					"class" => "",
					"value" => "",
					"type" => "textfield"
				...
				array(
					...
					"description" => wp_kses( __("Open current toggle item on show", "themerex"), $THEMEREX_GLOBALS['allowed_tags'] ),
					"class" => "",
