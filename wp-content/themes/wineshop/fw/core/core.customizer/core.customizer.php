...
if ( !function_exists( 'themerex_core_customizer_admin_menu_item' ) ) {
	...
	function themerex_core_customizer_admin_menu_item() {
		themerex_admin_add_menu_item('submenu', array(
			...
			'page_title' => esc_html__('Fonts & Colors', 'themerex'),
			'menu_title' => esc_html__('Fonts & Colors', 'themerex'),
	...
	function themerex_core_customizer_scheme_delete() {
		...
		if (isset($THEMEREX_GLOBALS['custom_colors'][$scheme])) {
			if (count($THEMEREX_GLOBALS['custom_colors']) > 1) {
				...
				$response['error'] = sprintf(esc_html__('You cannot delete last color scheme!', 'themerex'), $scheme);
		} else
			$response['error'] = sprintf(esc_html__('Color Scheme %s not found!', 'themerex'), $scheme);
			...
			foreach ($order as $slug) {
				if (is_array($THEMEREX_GLOBALS['custom_colors'][$slug]) && count($THEMEREX_GLOBALS['custom_colors'][$slug]) > 0) {
					...
					if ($slug == $scheme) {
						...
						$schemes[$new_slug]['title'] .= ' '.esc_html__('(Copy)', 'themerex');
					}
				}
			}
			$THEMEREX_GLOBALS['custom_colors'] = $schemes;
	...
	function themerex_core_customizer_page() {
		...
		if (is_array($THEMEREX_GLOBALS['custom_colors']) && count($THEMEREX_GLOBALS['custom_colors']) > 0) {
			...
			$options["partition_schemes"] = array(
				"title" => esc_html__('Color schemes', 'themerex'),
				"override" => "customizer",
			...
			foreach ($THEMEREX_GLOBALS['custom_colors'] as $slug=>$scheme) {
				...
				$options["{$slug}-description"] = array(
					"title" => sprintf(esc_html__('Color scheme "%s"', 'themerex'), $scheme['title']),
					"desc" => wp_kses( sprintf(__('Specify the color for each element in the scheme "%s". After that you will be able to use your color scheme for the entire page, any part thereof and/or for the shortcodes!', 'themerex'), $scheme['title']), $THEMEREX_GLOBALS['allowed_tags'] ),
					"override" => "customizer",
					"type" => "info");
				...
				$options["{$slug}-buttons_label"] = array(
					"desc" => wp_kses( __("You can duplicate current color scheme (appear on new tab) or delete it (if not last scheme)", 'themerex'), $THEMEREX_GLOBALS['allowed_tags'] ),
					"override" => "customizer",
					"divider" => false,
					"columns" => "4_6 first",
					"type" => "label");
				...
				$options["{$slug}-button_copy"] = array(
					"title" => esc_html__('Copy',  'themerex'),
					"override" => "customizer",
					"divider" => false,
					"columns" => "1_6",
					"icon" => "iconadmin-docs",
				...
				$options["{$slug}-button_delete"] = array(
					"title" => esc_html__('Delete',  'themerex'),
					"override" => "customizer",
					"divider" => false,
					"columns" => "1_6 last",
				...
				$options["{$slug}-slug"] = array(
					"title" => esc_html__('Slug',  'themerex'),
					"override" => "customizer",
					"divider" => false,
					"columns" => "1_5 last",
					"std" => "",
				...
				if ($demo_block) {
					$options["{$slug}-demo"] = array(
						"title" => esc_html__('Usage demo', 'themerex'),
						"desc" => wp_kses( __('Below you can see the example of decoration of the page with selected colors.', 'themerex'), $THEMEREX_GLOBALS['allowed_tags'] )
									. trim($demo_block),
						"override" => "customizer",
						"type" => "info");
				}
...
if (isset($scheme['accent1'])) {
				$options["{$slug}-accent_info"] = array(
					"title" => esc_html__('Accent colors', 'themerex'),
					"desc" => wp_kses( __('Specify colors for theme accented elements (if need). The theme may not use all of the colors.', 'themerex'), $THEMEREX_GLOBALS['allowed_tags'] ),
					"override" => "customizer",
					"type" => "info");

				// Accent 1 color
				$options["{$slug}-accent1_label"] = array(
					"title" => esc_html__('Accent 1', 'themerex'),
					"desc" => wp_kses( __('Select color for accented elements and their hover state', 'themerex'), $THEMEREX_GLOBALS['allowed_tags'] ),
					"override" => "customizer",
					"divider" => false,
					"columns" => "2_5 first",
					"type" => "label");
				...
				$options["{$slug}-accent1_hover"] = array(
					"title" => esc_html__('Hover', 'themerex'),
					"std" => "#2B2B2B",
...
if (isset($scheme['accent2'])) {
				...
				$options["{$slug}-accent2_label"] = array(
					"title" => esc_html__('Accent 2', 'themerex'),
					"desc" => wp_kses( __('Select color for accented elements and their hover state', 'themerex'), $THEMEREX_GLOBALS['allowed_tags'] ),
					"override" => "customizer",
					"divider" => false,
					"columns" => "2_5 first",
...
if (isset($scheme['accent3'])) {
				...
				$options["{$slug}-accent3_label"] = array(
					"title" => esc_html__('Accent 3', 'themerex'),
					"desc" => wp_kses( __('Select color for accented elements and their hover state', 'themerex'), $THEMEREX_GLOBALS['allowed_tags'] ),
					"override" => "customizer",
					"divider" => false,
					"columns" => "2_5 first",
...
if (isset($scheme['text'])) {
				...
				$options["{$slug}-text_info"] = array(
					"title" => esc_html__('Text and Headers', 'themerex'),
					"desc" => wp_kses( __('Specify colors for the plain text, post info blocks and headers', 'themerex'), $THEMEREX_GLOBALS['allowed_tags'] ),
					"override" => "customizer",
					"type" => "info");
	
				// Text - simple text, links in the text and their hover state
				$options["{$slug}-text_label"] = array(
					"title" => esc_html__('Text', 'themerex'),
					"desc" => wp_kses( __('Select colors for the text: normal text color, light text (for example - post info) and dark text (headers, bold text, etc.)', 'themerex'), $THEMEREX_GLOBALS['allowed_tags'] ),
					"override" => "customizer",
					"divider" => false,
					"columns" => "2_5 first",
					"type" => "label");
				...
				$options["{$slug}-text_light"] = array(
					"title" => esc_html__('Light', 'themerex'),
					"std" => "",
				...
				$options["{$slug}-text_dark"] = array(
					"title" => esc_html__('Dark', 'themerex'),
					"std" => "",
...
if (isset($scheme['inverse_text'])) {
				...
				$options["{$slug}-inverse_label"] = array(
					"title" => esc_html__('Inverse text', 'themerex'),
					"desc" => wp_kses( __('Select colors for inversed text (text on accented background)', 'themerex'), $THEMEREX_GLOBALS['allowed_tags'] ),
					"override" => "customizer",
					"divider" => false,
					"columns" => "2_5 first",
					"type" => "label");
				...
				$options["{$slug}-inverse_labe2l"] = array(
					"title" => esc_html__('Inverse links', 'themerex'),
					"desc" => wp_kses( __('Select colors for inversed links (links on accented background)', 'themerex'), $THEMEREX_GLOBALS['allowed_tags'] ),
					"override" => "customizer",
					"divider" => false,
					"columns" => "2_5 first",
					"type" => "label");
...
if (isset($scheme['bg_color'])) {
				...
				$options["{$slug}-block_info"] = array(
					"title" => esc_html__('Page/Block decoration', 'themerex'),
					"desc" => wp_kses( __('Specify border and background to decorate whole page (if scheme accepted to the page) or entire block/section.', 'themerex'), $THEMEREX_GLOBALS['allowed_tags'] ),
					"override" => "customizer",
					"type" => "info");
				...
				$options["{$slug}-bd_color_label"] = array(
					...
					"desc" => wp_kses( __('Select the border color and it hover state', 'themerex'), $THEMEREX_GLOBALS['allowed_tags'] ),
					"override" => "customizer",
					"divider" => false,
					"columns" => "2_5 first",
					"type" => "label");
				...
				$options["{$slug}-bg_color_label"] = array(
					...
					"desc" => wp_kses( __('Select the background color and it hover state', 'themerex'), $THEMEREX_GLOBALS['allowed_tags'] ),
					"override" => "customizer",
					"divider" => false,
					"columns" => "2_5 first",
					"type" => "label");
...
if (isset($scheme['bg_image'])) {
				...
				$options["{$slug}-bg_image_label"] = array(
					...
					"desc" => wp_kses( __('Select first background image and it display parameters', 'themerex'), $THEMEREX_GLOBALS['allowed_tags'] ),
					"override" => "customizer",
					"divider" => false,
					"columns" => "2_5 first",
					"type" => "label");
				...
				$options["{$slug}-bg_image_repeat"] = array(
					"title" => esc_html__('Repeat', 'themerex'),
					"std" => "",
				...
				$options["{$slug}-bg_image_attachment"] = array(
					"title" => esc_html__('Attachment', 'themerex'),
					"std" => "",
				...
				$options["{$slug}-bg_image2_label"] = array(
					"title" => esc_html__('Background image 2', 'themerex'),
					"desc" => wp_kses( __('Select second background image and it display parameters', 'themerex'), $THEMEREX_GLOBALS['allowed_tags'] ),
					"override" => "customizer",
					"divider" => false,
					"columns" => "2_5 first",
					"type" => "label");
...
if (isset($scheme['alter_text'])) {
				...
				$options["{$slug}-alter_info"] = array(
					"title" => esc_html__('Alternative colors: Footer & copyright areas', 'themerex'),
					"desc" => wp_kses( __('Specify colors to decorate inner blocks', 'themerex'), $THEMEREX_GLOBALS['allowed_tags'] ),
					"override" => "customizer",
					"type" => "info");
				...
				$options["{$slug}-alter_text_label"] = array(
					"title" => esc_html__('Text and Headers', 'themerex'),
					"desc" => wp_kses( __('Specify colors for the plain text, post info blocks and headers in the highlight blocks', 'themerex'), $THEMEREX_GLOBALS['allowed_tags'] ),
					"override" => "customizer",
					"divider" => false,
					"columns" => "2_5 first",
					"type" => "label");
				...
				$options["{$slug}-alter_link_label"] = array(
					"title" => esc_html__('Links', 'themerex'),
					"desc" => wp_kses( __('Specify colors for the links in the highlight blocks', 'themerex'), $THEMEREX_GLOBALS['allowed_tags'] ),
					"override" => "customizer",
					"divider" => false,
					"columns" => "2_5 first",
					"type" => "label");
				...
				$options["{$slug}-alter_bd_color_label"] = array(
					"title" => esc_html__('Border color', 'themerex'),
					"desc" => wp_kses( __('Select the border colors for the normal state and for active (focused) field', 'themerex'), $THEMEREX_GLOBALS['allowed_tags'] ),
					"override" => "customizer",
					"divider" => false,
					"columns" => "2_5 first",
					"type" => "label");
				...
				$options["{$slug}-alter_bg_color_label"] = array(
					"title" => esc_html__('Background Color', 'themerex'),
					"desc" => wp_kses( __('Select the background colors for the normal state and for active (focused) field', 'themerex'), $THEMEREX_GLOBALS['allowed_tags'] ),
					"override" => "customizer",
					"divider" => false,
					"columns" => "2_5 first",
					"type" => "label");
				...
				$options["{$slug}-alter_bg_image_label"] = array(
					"title" => esc_html__('Background image', 'themerex'),
					"desc" => wp_kses( __('Select alter background image and it display parameters', 'themerex'), $THEMEREX_GLOBALS['allowed_tags'] ),
					"override" => "customizer",
					"divider" => false,
					"columns" => "2_5 first",
					"type" => "label");
		...
		if (is_array($THEMEREX_GLOBALS['custom_fonts']) && count($THEMEREX_GLOBALS['custom_fonts']) > 0) {
			...
			$options["partition_fonts"] = array(
				"title" => esc_html__('Fonts', 'themerex'),
				"override" => "customizer",
				"icon" => "iconadmin-font",
				"type" => "partition");
			if ($start_partition) {
			...
			$list_weight = array(
				'inherit' => esc_html__("Inherit", 'themerex'), 
				'100' => esc_html__('100 (Light)', 'themerex'), 
				'300' => esc_html__('300 (Thin)',  'themerex'),
				'400' => esc_html__('400 (Normal)', 'themerex'),
				'500' => esc_html__('500 (Semibold)', 'themerex'),
				'600' => esc_html__('600 (Semibold)', 'themerex'),
				'700' => esc_html__('700 (Bold)', 'themerex'),
				'900' => esc_html__('900 (Black)', 'themerex')
			);
			...
			foreach ($THEMEREX_GLOBALS['custom_fonts'] as $slug=>$font) {
				...
				if (isset($font['font-size'])) {
					$options["{$slug}-font-size"] = array(
						"title" => $show_titles ? esc_html__('Size', 'themerex') : '',
						"desc" => '',
						"divider" => false,
						"columns" => "1_8",
						"std" => "",
				...
				if (isset($font['line-height'])) {
					$options["{$slug}-line-height"] = array(
						"title" => $show_titles ? esc_html__('Line height', 'themerex') : '',
						"desc" => '',
						"divider" => false,
						"columns" => "1_8",
						"std" => "",
				...
				if (isset($font['font-weight'])) {
					$options["{$slug}-font-weight"] = array(
						"title" => $show_titles ? esc_html__('Weight', 'themerex') : '',
						"desc" => '',
						"divider" => false,
						"columns" => "1_8",
						"std" => "",
				...
				if (isset($font['font-style'])) {
					$options["{$slug}-font-style"] = array(
						"title" => $show_titles ? esc_html__('Style', 'themerex') : '',
						"desc" => '',
						"divider" => false,
						"columns" => "1_8",
						"std" => "",
				...
				if (isset($font['margin-top'])) {
					$options["{$slug}-margin-top"] = array(
						"title" => $show_titles ? esc_html__('Margin Top', 'themerex') : '',
						"desc" => '',
						"divider" => false,
						"columns" => "1_8",
						"std" => "",
				...
				if (isset($font['margin-bottom'])) {
					$options["{$slug}-margin-bottom"] = array(
						"title" => $show_titles ? esc_html__('Margin Bottom', 'themerex') : '',
						"desc" => '',
						"divider" => false,
						"columns" => "1_8",
						"std" => "",
		...
		themerex_options_page_start(array(
			'title' => esc_html__('Fonts & Colors', 'themerex'),
			"icon" => "iconadmin-cog",
			"subtitle" => esc_html__('Fonts settings & Color schemes', 'themerex'),
			"description" => wp_kses( __('Customize fonts and colors for your site.', 'themerex'), $THEMEREX_GLOBALS['allowed_tags'] ),
			'data' => $options,
			'create_form' => true,
	...
	function themerex_core_customizer_prepare_scripts() {
		...
		<script type="text/javascript">
			jQuery(document).ready(function () {
				...
				THEMEREX_GLOBALS['to_strings'].scheme_delete			= "<?php esc_html_e("Delete color scheme", 'themerex'); ?>";
				THEMEREX_GLOBALS['to_strings'].scheme_delete_confirm	= "<?php esc_html_e("Do you really want to delete this color scheme?", 'themerex'); ?>";
				THEMEREX_GLOBALS['to_strings'].scheme_delete_complete	= "<?php esc_html_e("Current color scheme is successfully deleted!", 'themerex'); ?>";
				THEMEREX_GLOBALS['to_strings'].scheme_delete_failed		= "<?php esc_html_e("Error while delete color scheme! Try again later.", 'themerex'); ?>";
				THEMEREX_GLOBALS['to_strings'].scheme_copy				= "<?php esc_html_e("Copy color scheme", 'themerex'); ?>";
				THEMEREX_GLOBALS['to_strings'].scheme_copy_confirm		= "<?php esc_html_e("Duplicate this color scheme?", 'themerex'); ?>";
				THEMEREX_GLOBALS['to_strings'].scheme_copy_complete		= "<?php esc_html_e("Current color scheme is successfully duplicated!", 'themerex'); ?>";
				THEMEREX_GLOBALS['to_strings'].scheme_copy_failed		= "<?php esc_html_e("Error while duplicate color scheme! Try again later.", 'themerex'); ?>";
			});
		</script>
		<?php 
	}
